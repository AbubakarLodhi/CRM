    ...
    WithEvents
{
    ...
    public static function buildStatementRows(Collection $sales, array $selectedColumns = []): array
    {
        $entries = self::buildChronologicalEntries($sales);
        $runningBalance = 0.0;
    ...
    public static function calculateTotals(Collection $sales): array
    {
        $entries = self::buildChronologicalEntries($sales);
    ...
    {
        $rows = self::buildStatementRows($this->sales, $this->selectedColumns);
    ...
    protected static function buildChronologicalEntries(Collection $sales): array
    {
        $entries = [];
